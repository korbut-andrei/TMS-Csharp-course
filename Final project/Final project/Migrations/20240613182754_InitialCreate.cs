        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Careers_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CharacteristicReviews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CharacteristicReviews_Careers_CareerId",
                        column: x => x.CareerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewBulletPoints_Reviews_ReviewEntityId",
            ...
            migrationBuilder.CreateTable(
                name: "TypicalTaskReview",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TypicalTaskId = table.Column<int>(type: "int", nullable: false),
                    TypicalTaskEntityId = table.Column<int>(type: "int", nullable: false),
                    ReviewId = table.Column<int>(type: "int", nullable: false),
                    ReviewEntityId = table.Column<int>(type: "int", nullable: false),
                    DateTimeInUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TypicalTaskReviewId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypicalTaskReview", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TypicalTaskReview_Reviews_ReviewEntityId",
                        column: x => x.ReviewEntityId,
                        principalTable: "Reviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TypicalTaskReview_TypicalTaskReview_TypicalTaskReviewId",
                        column: x => x.TypicalTaskReviewId,
                        principalTable: "TypicalTaskReview",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TypicalTaskReview_TypicalTasks_TypicalTaskEntityId",
                        column: x => x.TypicalTaskEntityId,
                        principalTable: "TypicalTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacteristicReviews_CareerId",
                table: "CharacteristicReviews",
                column: "CareerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewBulletPoints_ReviewEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypicalTaskReview_ReviewEntityId",
                table: "TypicalTaskReview",
                column: "ReviewEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_TypicalTaskReview_TypicalTaskEntityId",
                table: "TypicalTaskReview",
                column: "TypicalTaskEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_TypicalTaskReview_TypicalTaskReviewId",
                table: "TypicalTaskReview",
                column: "TypicalTaskReviewId");
